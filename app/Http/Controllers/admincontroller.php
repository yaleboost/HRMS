...
class admincontroller extends Controller
{
        public function vieweremployee(){
            ...
            return view('admin.registeremployee',compact('department'));
            }
        ...
        {
            $this->updateStatus();    //calling update semester status 
        ...
        public function viewddepartment(){//for passing date to table
            $department = department::all();
            return view('admin.viewdepartment', compact('department'));
        }
        public function updatedepartment($id){
            $department = department::find($id);
            return view('admin.updatedepartment',compact('department'));
        }
        public function updatedepartmentconfirm(Request $request,$id){
