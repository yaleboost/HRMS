    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">HRMS<sup>Admin</sup></div>
            </a>
           ...
           <!-- Nav Item - Scholarship 1 Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseScholarship1"
                    aria-expanded="true" aria-controls="collapseScholarship1">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Scholarship </span>
                </a>
                <div id="collapseScholarship1" class="collapse" aria-labelledby="headingScholarship1" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="forgot-password.html">Completed</a>
            ...
            <!-- Nav Item - Scholarship 2 Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseScholarship2"
                    aria-expanded="true" aria-controls="collapseScholarship2">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Semester</span>
                </a>
                <div id="collapseScholarship2" class="collapse" aria-labelledby="headingScholarship2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
